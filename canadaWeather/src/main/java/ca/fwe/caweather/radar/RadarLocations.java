...
public class RadarLocations {
	...
	public static RadarLocation[] ALL = {
			...
			new RadarLocation("Spirit River", "Spirit River", "Grande Prairie", "Grande Prairie", "Alberta", "Alberta", "CASSR", "WWW", new LatLon(55.6925, -119.23), 6),
			...
			new RadarLocation("Bethune", "Bethune", "Regina", "Régina", "Saskatchewan", "Saskatchewan", "CASBE", "XBE", new LatLon(50.57108, -105.18268), 6),
			...
			new RadarLocation("Exeter", "Exeter", "Southwestern Ontario", "Ontario sud-ouest", "Ontario", "Ontario", "CASET", "WSO", new LatLon(43.37028, -81.38417), 6),
			...
			new RadarLocation("Chipman", "Chipman", "Central New Brunswick", "Frédéricton", "New Brunswick", "Nouveau-Brunswick", "CASCM", "XNC", new LatLon(46.22222, -65.69861), 6),
